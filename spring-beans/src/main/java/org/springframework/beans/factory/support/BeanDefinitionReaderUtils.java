...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		//todo 这里走的registerBeanDefinition#registerBeanDefinition
		//todo 最终都要调用DefaultListableBeanFactory#registerBeanDefinition，放到bean factory的beanDefinitionMap中去
		registry.registerBeanDefinition(beanName, definitionHolder.getBeanDefinition());

		// Register aliases for bean name, if any.
		//注册别名，就是放到一个专门存别名的map中
		/** {@link SimpleAliasRegistry#aliasMap }  ConcurrentHashMap 类型的 Map**/
